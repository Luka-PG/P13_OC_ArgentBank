...
export default function Profil() {
  ...
  //établissement du usestate pour l'edit du nom et prénom utilisateur
  ...
  //mis à jour des infos lors de l'appui du bouton edit
  ...
  function editNameForm() {
    //si l'utilisateur est en train de modifier son nom/prénom on affiche le form d'edit
    return editName ? (
      ...
      <div className="header editName-header">
        ...
        <form onSubmit={(e) => editNameSubmit(e)} className="editName-form">
          ...
          <div className="editName-buttons-container">
            <button type="submit" className="editName-button"> Save </button>
            <button type="button" className="editName-button" onClick={() => setEditName(false)}> Cancel </button>
          </div>
        </form>
      </div>
  ...
  return user.data ? (
    //si l'utilisateur est connecté et qu'il y à des données lié à l'utilisateur
